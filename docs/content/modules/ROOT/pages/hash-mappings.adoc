...
Redis OM Spring extends SDR Hash Mapping scheme to take advantage of the https://redis.io/docs/interact/search-and-query/[Redis Search Engine] available in Redis Stack.
