...
Redis Stack implements vector search through the RediSearch module, which provides:
...
Redis OM Spring supports three distance metrics for vector similarity:
