...
no longer necessary when using Redis OM Spring which relies on Redis Stack search engine to create proper search indices.
...
repository operations with RediSearch queries and aggregations.
